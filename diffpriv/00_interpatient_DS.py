...
To run:
    ...
    cd diffpriv/
    nohup python -m 00_interpatient_DS > logs/interpatient_DS_self.log 2>&1
    nohup python -m 00_interpatient_DS > logs/interpatient_DS_original.log 2>&1
    ...
    with tf.compat.v1.Session() as sess:
        ...
        for epoch_i in range(start_epoch, epochs):
            ...
            if (epoch_i+1)%test_steps==0:
                ...
                all_results[epoch_i] = test_results
                with open(osj("..", "results", "interpatient", f"results_self.pkl"), "wb") as f:
                # with open(osj("..", "results", "interpatient", f"results_o.pkl"), "wb") as f:
        ...
        with open(osj("..", "results", "interpatient", f"loss_self.pkl"), "wb") as f:
        # with open(osj("..", "results", "interpatient", f"loss_o.pkl"), "wb") as f:
...
def main():
    ...
    # parser.add_argument('--data_dir', type=str, default='../data/s2s_mitbih_aami_DS1DS2_original') # to run on pre-processed data
    parser.add_argument('--data_dir', type=str, default='../data/s2s_mitbih_aami_DS1DS2') # to run on self processed data
    ...
    # parser.add_argument('--checkpoint_dir', type=str, default='checkpoints-seq2seq_DS1DS2_o')
