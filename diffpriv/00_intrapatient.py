...
To run:
    ...
    cd diffpriv/
    nohup python -m 00_intrapatient > logs/intrapatient_self.log 2>&1
    nohup python -m 00_intrapatient > logs/intrapatient_original.log 2>&1
    ...
    with tf.compat.v1.Session() as sess:
        ...
        for epoch_i in range(start_epoch, epochs):
            ...
            if (epoch_i+1)%test_steps==0:
                ...
                with open(osj("..", "results", "intrapatient", f"results_self.pkl"), "wb") as f:
                # with open(osj("..", "results", "intrapatient", f"results_o.pkl"), "wb") as f:
        ...
        with open(osj("..", "results", "intrapatient", f"loss_self.pkl"), "wb") as f:
        # with open(osj("..", "results", "intrapatient", f"loss_o.pkl"), "wb") as f:
...
def main():
    ...
    data_source = ["original", "self-trained"]
    for source in data_source:
        ...
        if source == "original":
            parser.add_argument('--data_dir', type=str, default='../data/s2s_mitbih_aami_original')
            parser.add_argument('--checkpoint_dir', type=str, default='checkpoints-seq2seq_o')
        elif source == "self-trained":
        ...
        parser.add_argument('--classes', nargs='+', type=chr,
                            default=['F','N','S','V']) # without Q! (Ricarda)
