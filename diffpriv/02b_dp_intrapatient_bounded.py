...
To run:
    ...
    cd diffpriv/
    nohup python -m 02b_dp_intrapatient_bounded > logs/intra/intrapatient_bounded.log 2>&1
    nohup python -m 02b_dp_intrapatient_bounded > logs/intra/intrapatient_bounded_2.log 2>&1
    nohup python -m 02b_dp_intrapatient_bounded > logs/intra/intrapatient_bounded_3.log 2>&1

Runtime:
    5 minutes per combination of epsilon and delta 
    (goes up to 4 hours the longer the process)
...
def main():
    ...
    parser.add_argument('--checkpoint_dir', type=str, default='dp_checkpoints/bounded_n/checkpoints')
