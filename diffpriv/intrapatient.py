...
To run in background:
    ...
    cd diffpriv/
    nohup python -m intrapatient > logs/intrapatient.log 2>&1
...
def main():
    ...
    parser.add_argument('--data_dir', type=str, default='../data/s2s_mitbih_aami_original') # pre-processed
    #parser.add_argument('--data_dir', type=str, default='../data/s2s_mitbih_aami') # own processed
