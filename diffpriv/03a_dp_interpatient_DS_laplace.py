...
To run:
    ...
    cd diffpriv/
    nohup python -m 03a_dp_interpatient_DS_laplace > logs/inter/interpatient_laplace.log 2>&1
    nohup python -m 03a_dp_interpatient_DS_laplace > logs/inter/interpatient_laplace_2.log 2>&1
    nohup python -m 03a_dp_interpatient_DS_laplace > logs/inter/interpatient_laplace_3.log 2>&1
    nohup python -m 03a_dp_interpatient_DS_laplace > logs/inter/interpatient_laplace_4.log 2>&1
...
def main():
    ...
    parser.add_argument('--checkpoint_dir', type=str, default='dp_checkpoints_DS/laplace/checkpoints')
